...
![AIMS grid sales insights](https://github.com/user-attachments/assets/198274e3-e3d7-497a-8a4e-ec2ea66fd89c)
...
6. In the currency there were two types of currencies in transactions, performed currency conversion to make all the 
   currency type same
7. Data Validation
